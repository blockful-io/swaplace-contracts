...
Interface of the ERC165 standard, as defined in the [https://eips.ethereum.org/EIPS/eip-165\[EIP\]](https://eips.ethereum.org/EIPS/eip-165).

Implementers can declare support of contract interfaces, which can then be queried by others ({ERC165Checker}).

For an implementation, see {ERC165}.

* [Source Code](https://github.com/blockful-io/swaplace-contracts/blob/develop/contracts/interfaces/IERC165.sol)
