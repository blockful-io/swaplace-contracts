...
abstract contract ERC20 is IERC20, IERC20Permit, IERC20Errors {
  ...
  function decreaseAllowance(
    ...
    unchecked {
      ...
      _allowance[msg.sender][spender] = currentAllowance - requestedDecrease;
  ...
  function permit(
    ...
    unchecked {
      ...
      address recoveredAddress = ecrecover(
        keccak256(abi.encodePacked(hex"19_01", _domainSeparator, structHash)),
        v,
        r,
        s
      );
  ...
  function permitTransfer(
    ...
    unchecked {
      bytes32 structHash = keccak256(
        abi.encode(_permitTypehash, from, to, value, _nonces[from]++, deadline)
      );
      address recoveredAddress = ecrecover(
        keccak256(abi.encodePacked(hex"19_01", _domainSeparator, structHash)),
        v,
